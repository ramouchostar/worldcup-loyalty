...
import { CountUp, FillBar, useScrollScrub } from "./motion";
...
//
// Hauteur d'écran fixe (proportion téléphone réel) au lieu d'empiler tout le
// contenu sans limite — le surplus défile à l'intérieur, synchronisé au
// scroll de la page (useScrollScrub), comme si on faisait défiler l'appli.
// La barre d'onglets reste fixe en bas, comme dans une vraie app.
  ...
  return (
    <div className="bg-paper rounded-[25px] overflow-hidden flex flex-col font-landing">
      ...
      >
        ...
        {/* Indice visuel de défilement — la barre d'onglets fixe en dessous
            suffit à faire comprendre "c'est une app", ce dégradé fait
            comprendre "il y a plus de contenu, fais défiler". */}
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-10 bg-gradient-to-t from-paper to-transparent" />
      </div>

      <div className="bg-white border-t border-paper-border flex justify-around px-1 pt-2 pb-3 shrink-0">
