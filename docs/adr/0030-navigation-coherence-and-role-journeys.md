...
**Statut** : Accepté (2026-08-05) — §4 (ordre du dashboard, tuiles) remplacé par l'[ADR 0059](0059-l-accueil-repond-a-trois-questions.md) le 2026-09-14 — §9 (sidebar en 4 sections) devient la navigation de la **vue pro** depuis l'[ADR 0064](0064-la-console-repond-a-trois-questions.md) (2026-09-21) : la vue simple, par défaut, a quatre onglets et liste le reste dans « Plus » — **décisions validées par le porteur (session de grill), PAS encore implémentées**. Périmètre : navigation, points d'entrée, retours arrière, parcours post-action, et deux écrans à créer (« Membres » plateforme / « Mes clients » resto). Aucun changement au modèle de données hors ces deux écrans.
