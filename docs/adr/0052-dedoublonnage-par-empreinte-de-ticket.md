...
0048 → 0052 : le numéro 0048 a été pris entre-temps par « Le gain avant le compte »
(règle de collision du projet — le dernier arrivé change de numéro). Migration :
`docs/migrations/20260910-1040-dedoublonnage-tickets.sql`.
...
La migration `20260910-1040` s'applique à la main (docs/migrations/README.md). Tant
...
### Schéma (`docs/migrations/20260910-1040-dedoublonnage-tickets.sql`)
