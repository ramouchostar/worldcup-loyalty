...
Après la photo, un ticket **bien lu** (montant accepté, numéro lu, année non réparée, pas de doublon) part tout seul : « Vérification en cours... » puis le résultat, sans tap. Le **récap** (« Montant · Numéro », modifiable au tap, bouton « Envoyer mon ticket » collé au-dessus de la barre du bas) n'apparaît que quand une lecture est à vérifier (année réparée), que l'envoi échoue, ou que la personne choisit la saisie à la main après deux photos ratées (ADR 0057). La confirmation « commande passée directement au restaurant, pas via une plateforme » accompagne la photo (« En prenant la photo, tu confirmes… »). La photo reste sur l'appareil jusqu'à la réponse du serveur, visiteur comme membre.
_Avoid_ : un bouton d'envoi qu'il faut scroller pour atteindre ; traiter la photo prise comme la fin du parcours (rien n'est gagné tant que le serveur n'a pas le ticket).
