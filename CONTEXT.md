...
La photo se prend **dans l'app** (vue caméra plein écran, cadre total + clé de commande — ADR 0056) ; l'appareil photo du téléphone et la galerie restent le repli. Tout message (photo refusée, erreur d'envoi, doublon) s'affiche **en haut de l'écran**, jamais sous la ligne de flottaison.
...
Après la photo, un ticket **bien lu** (montant accepté, numéro lu, année non réparée, pas de doublon) part tout seul : « Vérification en cours... » puis le résultat, sans tap. Le **récap** (« Montant · Numéro », modifiable au tap, bouton « Envoyer mon ticket » collé au-dessus de la barre du bas) n'apparaît que quand une lecture est à réparer ou que l'envoi échoue. La confirmation « commande passée directement au restaurant, pas via une plateforme » accompagne la photo (« En prenant la photo, tu confirmes… »). La photo reste sur l'appareil jusqu'à la réponse du serveur, visiteur comme membre.
